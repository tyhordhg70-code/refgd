...
type Props = {
  accent?: string;
  className?: string;
  /** Legacy — no longer used (was scroll-runway multiplier). */
  scrollLength?: number;
};
...
export default function PixelRainCosmic({
  ...
  useEffect(() => {
    ...
    type Col = {
      speed: number; depth: number; hueShift: number;
      alphaPeak: number; flicker: number; lastGlyph: string;
    };
    let columns: Col[] = [];
