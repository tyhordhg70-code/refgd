...
/**
 * EvadeTrustSplit v4 — outer panel is static (was a SafeReveal that
 * could catch the trust-reviews image mid-translate on rescroll).
 * Heading slides up, image slides in from the right, story cards fan
 * in with stagger — all opacity:1 throughout, once:true so nothing
 * vanishes on scroll-back.
 */
      ...
      <div className="container-wide relative">
        ...
        >
          ...
          <div className="relative grid items-center gap-8 lg:grid-cols-[minmax(0,1fr)_auto] lg:gap-12">
            <SafeReveal kind="lift" delay={0.05}>
