...
/**
 * EvadeSolutionsStack — chapter 2. Sol-locks lives in a two-column layout
 * (heading + intro body on left, image on right) inside the violet
 * container — same editorial pattern as EvadeShieldMoment and
 * EvadeIntroEditorial — instead of floating below the heading with no
 * surrounding text.
 */
  ...
  return (
    <section className="relative z-10 pt-8 pb-20 sm:pt-12 sm:pb-28">
      <div className="container-wide relative">
        <div className="relative overflow-hidden rounded-[2rem] border border-violet-400/25 px-6 py-12 sm:p-12 lg:p-14"
          style={{
          ...
          <div className="relative grid items-center gap-10 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,1fr)] lg:gap-14">
            <div>
              ...
              <KineticText
                ...
                className="editorial-display mt-8 max-w-2xl text-balance uppercase text-white text-[clamp(2rem,5vw,3.6rem)]"
            ...
            <SafeReveal className="relative" kind="swingInR" delay={0.15} duration={1.15}>
              <div className="relative">
                <span aria-hidden className="pointer-events-none absolute inset-x-8 -bottom-4 h-14 rounded-[100%]"
                  style={{ background: "radial-gradient(ellipse 60% 100% at 50% 0%, rgba(167,139,250,0.55), transparent 70%)", filter: "blur(24px)" }} />
                <EditableImage
                  ...
                  className="mx-auto block h-auto w-full max-w-[400px] lg:max-w-none object-contain drop-shadow-[0_30px_70px_rgba(167,139,250,0.45)]"
                />
              </div>
            </SafeReveal>
          </div>
