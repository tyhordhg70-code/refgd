 ...
 *
 * Composition rules:
 *   - Page-scoped <CosmicBackground/> + <LiquidParticles/> create
 *     a continuously pulsating cosmic backdrop that speeds up while
 *     the user scrolls.
 *   - One ambient Spline panel only, transparently blended.
 *   - Side illustrations live INSIDE 12-column grids using `inline`
 *     mode — they scale gracefully on every viewport and never get
 *     cropped at the edges of the container.
 *   - Long-form copy uses TextReveal with rotating variants
 *     (wordFade / wordBlur / wordSlide / charBounce / lineMask) so
 *     the same scroll-effect never repeats.
 *   - Numbered "what's included" lists use BounceList for the
 *     fly-up-and-bounce-against-the-row-above motion.
 *   - The closing headline uses ExplodeText (reverse explosion).
 */
export default function MentorshipsPage() {
  return (
    <div className="relative">
      {/* Page-scoped cosmic backdrop + liquid bubble field */}
      <CosmicBackground />
      <LiquidParticles count={26} />
          ...
          <div className="grid gap-10 lg:grid-cols-12 lg:gap-14">
            ...
            <div className="lg:col-span-5 lg:pt-20">
              <Reveal delay={0.15}>
                ...
                >
                  <p className="heading-display text-[10px] font-semibold uppercase tracking-[0.35em] text-amber-200 sm:text-xs sm:tracking-[0.4em]">
                    — private add-on
                  </p>
                  <h4 className="editorial-display mt-3 text-xl font-bold uppercase tracking-tight text-amber-50 sm:text-2xl">
                  ...
                  <p className="mt-6 text-xs italic text-amber-100/80">
                    Please note: this is not included in the regular
                    mentorship — it is a separate add-on.
                  </p>
                </div>

                {/* New illustration BELOW the box (not behind it) so it
                    never impacts text readability. */}
          ...
          <ParallaxBlock amount={40}>
            <div className="mx-auto max-w-5xl text-center">
              ...
              <div className="mt-10 space-y-6 text-left text-base leading-relaxed text-white/85 sm:text-lg">
                <TextReveal variant="wordBlur">
                  ✒️ This mentorship covers all the fundamentals of
              ...
              {/* Wallet/money illustration with 3D rotation animation */}
              <div className="mt-14 flex justify-center">
                <ScrollImage
                  src="/illustrations/wallet-money.png"
                  alt=""
                  side="left"
                  glow="amber"
                  inline
                  width="w-[300px] sm:w-[380px] lg:w-[460px]"
        ...
        <div className="container-wide">
          <div className="grid items-start gap-10 lg:grid-cols-12 lg:gap-14">
            ...
            <div className="lg:col-span-7">
              ...
              <BounceList items={REFUND_FEATURES} accent="violet" />
      ...
      {/* ─── Act 6 — Ambient Spline panel (truly transparent) ─────── */}
        ...
        <div className="container-wide">
          <div className="grid items-start gap-10 lg:grid-cols-12 lg:gap-14">
            ...
            <div className="lg:col-span-7">
              ...
              <BounceList items={SE_FEATURES} accent="cyan" />
            </div>
          </div>
        </div>
      </section>
            ...
            <div className="lg:order-1 lg:col-span-7">
              <Reveal>
                <p
                  ...
                  style={{ textShadow: "0 0 24px rgba(251,191,36,0.55)" }}
                >
                  — additional add-ons
                </p>
                <KineticText
              ...
              <ul className="mt-10 space-y-5 text-base leading-relaxed text-white/90 sm:text-lg">
                {ADDONS.map((a) => (
                  <li key={a} className="flex items-start gap-4">
                    ...
                    <TextReveal spread={0.7} variant="wordSlide" className="flex-1">{a}</TextReveal>
                  </li>
                ))}
              </ul>
