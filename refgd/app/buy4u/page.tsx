...
const LOGO_SRC: Record<string, string> = {
  ...
  "subway.com": "https://upload.wikimedia.org/wikipedia/commons/thumb/7/73/A_Subway_restaurant_in_a_strip_mall_in_Franklin%2C_North_Carolina%2C_United_States.jpg/400px-A_Subway_restaurant_in_a_strip_mall_in_Franklin%2C_North_Carolina%2C_United_States.jpg",
  ...
  "dunkindonuts.com": "https://upload.wikimedia.org/wikipedia/commons/d/d4/Dunkin%27_Donuts_storefront.jpg",
  "popeyes.com": "https://upload.wikimedia.org/wikipedia/commons/thumb/6/66/Popeyes_Louisiana_Kitchen_%2851195358373%29.jpg/400px-Popeyes_Louisiana_Kitchen_%2851195358373%29.jpg",
  "shakeshack.com": "https://upload.wikimedia.org/wikipedia/commons/c/c2/Shake_Shack_Madison_Square.jpg",
  "sweetgreen.com": "https://upload.wikimedia.org/wikipedia/commons/thumb/f/f7/Nicolas_Jammet_and_Jonathan_Neman_at_their_Dupont_Circle_Sweetgreen_restaurant%2C_2014.jpg/400px-Nicolas_Jammet_and_Jonathan_Neman_at_their_Dupont_Circle_Sweetgreen_restaurant%2C_2014.jpg",
  "outback.com": "https://upload.wikimedia.org/wikipedia/commons/d/db/Outback_Steakhouse.jpg",
  ...
  "hooters.com": "https://upload.wikimedia.org/wikipedia/en/thumb/f/f5/Hooters_logo_1983-2013.svg/400px-Hooters_logo_1983-2013.svg.png",
  "ihop.com": "https://upload.wikimedia.org/wikipedia/commons/thumb/a/ad/IHOP_logo.svg/400px-IHOP_logo.svg.png",
  "aa.com": "https://upload.wikimedia.org/wikipedia/commons/thumb/3/39/American_Airlines_Boeing_777-300ER_%282-1_crop%29.jpg/400px-American_Airlines_Boeing_777-300ER_%282-1_crop%29.jpg",
  "southwest.com": "https://upload.wikimedia.org/wikipedia/commons/thumb/b/b0/Southwest_Boeing_737-8_MAX_N8971L_BWI_MD1.jpg/400px-Southwest_Boeing_737-8_MAX_N8971L_BWI_MD1.jpg",
  "spirit.com": "https://upload.wikimedia.org/wikipedia/commons/thumb/8/86/Spirit_Airlines_A320neo_N993NK_BWI_MD1.jpg/400px-Spirit_Airlines_A320neo_N993NK_BWI_MD1.jpg",
  "flyfrontier.com": "https://upload.wikimedia.org/wikipedia/commons/thumb/6/6b/Hamburg_Finkenwerder_Airport_Frontier_Airlines_Airbus_A321-271NX_N611FR_%28DSC02850%29.jpg/400px-Hamburg_Finkenwerder_Airport_Frontier_Airlines_Airbus_A321-271NX_N611FR_%28DSC02850%29.jpg",
  "alaskaair.com": "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e9/Alaska_Boeing_737-900ER_N407AS_departing_Boston_June_2025.jpg/400px-Alaska_Boeing_737-900ER_N407AS_departing_Boston_June_2025.jpg",
  "qatarairways.com": "https://upload.wikimedia.org/wikipedia/commons/f/fe/Qatar_Airways_Airbus_A350-1000_%28A7-ANA%29.jpg",
  "lufthansa.com": "https://upload.wikimedia.org/wikipedia/commons/thumb/6/6e/D-AIXO_Lufthansa_A359_MUC_%22Ulm%22_%2849033191421%29.jpg/400px-D-AIXO_Lufthansa_A359_MUC_%22Ulm%22_%2849033191421%29.jpg",
  "finnair.com": "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a3/Airbus_A350-941_%27OH-LWA%27_Finnair_%2822457807972%29.jpg/400px-Airbus_A350-941_%27OH-LWA%27_Finnair_%2822457807972%29.jpg",
  "koreanair.com": "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8b/Korean_Air_Boeing_777-300ER_HL8008_departing_Boston%2C_April_2025.jpg/400px-Korean_Air_Boeing_777-300ER_HL8008_departing_Boston%2C_April_2025.jpg",
  "cathaypacific.com": "https://upload.wikimedia.org/wikipedia/commons/thumb/b/b8/Cathay_Pacific_A350-1000XWB_B-LXA.jpg/400px-Cathay_Pacific_A350-1000XWB_B-LXA.jpg",
  "westjet.com": "https://upload.wikimedia.org/wikipedia/commons/8/87/WestJet_737_MAX_8_2.jpg",
  "vietnamairlines.com": "https://upload.wikimedia.org/wikipedia/commons/2/2f/20250402_Airbus_A350-941_of_Vietnam_Airlines_%28VN-A899%29_taking_off_from_SYD.jpg",
  "flynorse.com": "https://upload.wikimedia.org/wikipedia/commons/thumb/b/b2/Berlin_Brandenburg_Airport_Norse_Atlantic_Airways_Boeing_787-9_Dreamliner_LN-FNA_%28DSC02373%29.jpg/400px-Berlin_Brandenburg_Airport_Norse_Atlantic_Airways_Boeing_787-9_Dreamliner_LN-FNA_%28DSC02373%29.jpg",
  "flyporter.com": "https://upload.wikimedia.org/wikipedia/commons/thumb/c/c1/Porter_Airlines_E195-E2.jpg/400px-Porter_Airlines_E195-E2.jpg",
  "airindia.com": "https://upload.wikimedia.org/wikipedia/commons/4/45/VT-JRF_%40_JFK%2C_2024-11-04.png",
  "seaworld.com": "https://upload.wikimedia.org/wikipedia/en/thumb/5/59/Seaworld_logo.svg/400px-Seaworld_logo.svg.png",
  "sixflags.com": "https://upload.wikimedia.org/wikipedia/commons/7/7c/Cedar_Fair%27s_headquarters_at_Cedar_Point_%283667%29.jpg",
  ...
  "cava.com": "https://upload.wikimedia.org/wikipedia/commons/thumb/f/f8/Cava_restaurant_at_Union_Station_in_Washington%2C_D.C._01.jpg/600px-Cava_restaurant_at_Union_Station_in_Washington%2C_D.C._01.jpg",
  "texasroadhouse.com": "https://upload.wikimedia.org/wikipedia/en/thumb/b/b0/Texas_Roadhouse.svg/600px-Texas_Roadhouse.svg.png",
  "turkishairlines.com": "https://upload.wikimedia.org/wikipedia/commons/thumb/5/50/Berlin_Brandenburg_Airport_Turkish_Airlines_Airbus_A350-941_TC-LGJ_%28DSC01105%29.jpg/600px-Berlin_Brandenburg_Airport_Turkish_Airlines_Airbus_A350-941_TC-LGJ_%28DSC01105%29.jpg",
  "copaair.com": "https://upload.wikimedia.org/wikipedia/commons/e/e3/Copa_Airlines_Boeing_737-8V3_%28HP-1722CMP%29_at_Miami_International_Airport.jpg",
...
const SECTIONS: Section[] = [
  ...
  { id:"attractions",label:"Attractions & Tours",icon:"🎡",hasRefund:true,buy4u:{
    ...
    cards:[
            C("a01","Knott's Berry Farm","https://upload.wikimedia.org/wikipedia/commons/3/3f/Xcelerator_%28Knott%27s_Berry_Farm%29_2.jpg"),
      C("a02","Kings Dominion","https://upload.wikimedia.org/wikipedia/commons/8/88/Pantherian_at_Kings_Dominion_%28wide_shot%29.jpg"),
      C("a03","Carowinds","https://upload.wikimedia.org/wikipedia/en/e/e1/Fury_325_logo.png"),
      C("a04","Six Flags","https://upload.wikimedia.org/wikipedia/commons/thumb/1/15/Six_Flags_Great_Adventure_entrance_gate_1.jpg/600px-Six_Flags_Great_Adventure_entrance_gate_1.jpg"),
      C("a05","SeaWorld","https://upload.wikimedia.org/wikipedia/commons/6/6e/Antarctica_Empire_of_the_Penguin_entrance_1.jpg"),
      C("a06","LEGOLAND","https://upload.wikimedia.org/wikipedia/commons/f/fa/Legolandcaliforniaentrance.JPG"),
      C("a07","Sesame Place","https://upload.wikimedia.org/wikipedia/commons/thumb/1/1a/Sesame_Place_%2854062957549%29.jpg/600px-Sesame_Place_%2854062957549%29.jpg"),
      C("a08","Nickelodeon Universe","https://upload.wikimedia.org/wikipedia/commons/3/3f/Xcelerator_%28Knott%27s_Berry_Farm%29_2.jpg"),
      C("a09","Hershey Park","https://upload.wikimedia.org/wikipedia/commons/thumb/2/29/Hersheypark_Entrance_10-2-2022.jpg/600px-Hersheypark_Entrance_10-2-2022.jpg"),
      C("a10","Disney","https://upload.wikimedia.org/wikipedia/commons/thumb/6/6b/Cinderella_Castle%2C_Magic_Kingdom_Walt_Disney_World_%282024%29.jpg/600px-Cinderella_Castle%2C_Magic_Kingdom_Walt_Disney_World_%282024%29.jpg"),
      C("a11","Universal Studios","https://upload.wikimedia.org/wikipedia/en/d/d9/Universal_Studios_Florida_2023_logo.png"),
      C("a12","Viator","https://images.unsplash.com/photo-1469854523086-cc02fe5d8800?auto=format&fit=crop&w=400&q=80"),B("a12","Viator","viator.com"),
      C("a13","Safari Parks & Zoos","https://images.unsplash.com/photo-1564349683136-77e08dba1ef7?auto=format&fit=crop&w=400&q=80"),
      C("a14","Water Parks","https://images.unsplash.com/photo-1469474968028-56623f02e42e?auto=format&fit=crop&w=400&q=80"),
      C("a15","Bounce Houses","https://images.unsplash.com/photo-1530077593-6f539cfd090c?auto=format&fit=crop&w=400&q=80"),
      ...
      C("a18","Sports Games","https://images.unsplash.com/photo-1543499093-1f3d85ba2f19?auto=format&fit=crop&w=400&q=80"),
      ...
      C("a22","Jet Skis & Boat Rentals","https://images.unsplash.com/photo-1564578165-0d72d17fb0d3?auto=format&fit=crop&w=400&q=80"),
      ...
      C("a29","Escape Rooms","https://images.unsplash.com/photo-1561558618666-fcd25c85cd64?auto=format&fit=crop&w=400&q=80"),
