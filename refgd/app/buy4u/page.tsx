...
const GC_CARDS: GiftCard[] = [
  ...
  {key:"sgc167",name:"Dave & Busters",brand:"Dave & Busters",category:"Entertainment",states:["AL","AK","AR","CA","CO","CT","FL","GA","HI","ID","IL","IN","KS","KY","LA","MD","MA","MI","MN","MO","NE","NV","NH","NJ","NM","NY","NC","OH","OK","OR","PA","PR","RI","SC","SD","TN","TX","UT","VA","WA","WI"],availability:["In Stock","PDF","In-Store"],price:"40% off"},
