...
const SECTIONS: Section[] = [
  { id:"flights",label:"Flights",icon:"✈",hasRefund:false,buy4u:{
    ...
    cards:[
      ...
      C("f03","Alaska Airlines","https://brandlogos.net/wp-content/uploads/2021/11/alaska_airlines_eskimo-logo-300x300.png"),
      B("f04","Allegiant Air","allegiantair.com"),
      B("f05","Frontier Airlines","flyfrontier.com"),
      C("f06","Southwest Airlines","https://companieslogo.com/img/orig/LUV-8f519f22.png?t=1720244492"),
      B("f07","Spirit Airlines","spirit.com"),
      C("f08","Qatar Airways","https://thumbs.dreamstime.com/b/print-205336898.jpg"),
      C("f09","Breeze Airways","https://images.seeklogo.com/logo-png/62/2/breeze-airways-logo-png_seeklogo-621286.png"),
      B("f10","KLM","klm.com"),
      B("f11","Norse Atlantic","flynorse.com"),
      B("f12","WestJet","westjet.com"),
      B("f13","Finnair","finnair.com"),
      C("f14","Porter Airlines","https://www.flyporter.com/Content/responsive/images/browser-icons/mr-porter-logo.svg?version=9.9.9.1"),
      B("f15","Air India (Intl Only)","airindia.com"),
      C("f16","Japan Airlines","https://cdn.freebiesupply.com/logos/large/2x/japan-airlines-5-logo-png-transparent.png"),
      B("f17","Turkish Airlines","turkishairlines.com"),
      B("f18","Korean Air","koreanair.com"),
      C("f19","EVA Air","https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSDwE0aRvoynjvsVz7aax8ABy3yjZZxRs25fw&s"),
      B("f20","Cathay Pacific","cathaypacific.com"),
      C("f21","Vietnam Airlines","https://img.static-fb.com/transform/5ed9c2bf-54b9-45f1-bfe2-402fe5d4cda8/Vietnam-Airlines"),
  ...
  { id:"food",label:"Food",icon:"🍔",hasRefund:true,buy4u:{
    ...
    cards:[
      ...
      C("fd04","Blaze Pizza","https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcThdbYovnBkKJIumesZsPH6-YH4kEc7VyMu1Q&s"),
      ...
      C("fd34","IHOP","https://cdn.freebiesupply.com/logos/thumbs/2x/ihop-logo.png"),
      ...
      C("fd38","Jimmy John's","https://1000logos.net/wp-content/uploads/2024/02/Jimmy-Johns-logo.jpg"),
      ...
      C("fd50","P.F. Chang's","https://cdn.freebiesupply.com/logos/thumbs/1x/pf-changs-logo-logo.png"),
      ...
      C("fd68","Taco Bell","https://cdn.worldvectorlogo.com/logos/taco-bell-1.svg"),
      B("fd69","Texas de Brazil","texasdebrazil.com"),
      C("fd70","Texas Roadhouse","https://download.logo.wine/logo/Texas_Roadhouse/Texas_Roadhouse-Logo.wine.png"),
      ...
      C("fd76","Wingstop","https://images.seeklogo.com/logo-png/61/2/wingstop-logo-png_seeklogo-611067.png"),
