...
export default async function HomePage() {
  ...
  return (
    <>
      ...
      {/* Act 2 — Chapter 01 / Path picker. Solid backdrop card so the
          headline POPS even over the galaxy. */}
      <section className="relative pb-24 pt-20 sm:pt-28" id="paths">
      ...
      {/* Act 3 — Telegram CTA, animated illustration replaces static image */}
